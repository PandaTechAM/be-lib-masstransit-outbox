...
public class Settings
{
   ...
   /// <summary>
   ///    How long a message lease is held before it expires and becomes available for reprocessing.
   ///    Protects against double-processing when a publisher or consumer crashes mid-flight. Default: 5 minutes.
   /// </summary>
